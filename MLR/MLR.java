...
public class MLR{
    ...
    public double DS(){
        return ((ds_Xi1.size()*sumX2i1()*sumXi1())-(sumXi1()*sumXi1Xi2()*sumXi2())-(sumXi2()*sumXi1()*sumXi1Xi2())-(sumXi2()*sumX2i1()*sumXi2())-(sumXi1Xi2()*sumXi1Xi2()*ds_Xi1.size())-(sumX2i2()*sumXi1()*sumXi1()));
    }
    ...
    public static void main(String[]args){
        ...
        System.out.println("x2i1 "+obj1.sumX2i2());
